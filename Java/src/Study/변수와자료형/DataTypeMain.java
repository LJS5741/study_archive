...
public class DataTypeMain {  // 파스칼 표기법
    public static void main(String[] args) {
        ...
        char gender = '가';  // 문자를 저장, 2byte, 부호가 없음, 내부적으로는 정수값이 사용 됨, 문자는 '', 문자열 ""
        System.out.println((int)gender);
        // 문자열은 참조 타입(실제 값이 저장되는 것이 아니고 주소가 저장 됨), "문자열"은 리터럴 상수로 취금 됨
        String addr = "경기도 수원시 권선구 권선동";
        // Number 타입은 정수형과 실수형으로 나누어 짐
        // 정수형 : byte(1), short(2), int(4), long(8) : 수수점 이하가 없고, 부호가 있음
        byte num1 = 127;
        ...
        // 상수(constant) : 변수와 다른점은 값이 대입된 후 변경 할 수 없음
        ...
        // 명식적 형변환 : 개발자가 의도로를 가지고 형을 변경 하는 것
