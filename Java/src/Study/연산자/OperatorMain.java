package Study.연산자;
// Study.연산자 : 프로그램에서 사용하는 값을 연산해야 하는 경우에 사용
// 산술연산자 : 사칙연산과 나머지 연산(+, -, *, /, %)
// 대입연산자 : 변수에 값을 대입할 때 사용 (=, +=, -=, *=, /=, %=)
// 증감연산자 : ++, --, 단항연산자, 변수의 값을 1증가 혹은 1감소 시키는 Study.연산자
// 비교연산자 : ==, >, <, >=,<=, !=, 좌변과 우변의 값을 비교하여 결과를 참과 거짓으로 판별함
// 논리연산자 : &&(and, 좌항과 우항을 모두 만족해야 참), ||(or, 좌항과 우항 둘 중 하나만 만족하면 참), !(not, 현재의 상태를 부정)
// 삼항연선자 : 참과 거짓만 있는 조건문을 만들 수 있음, 항이 3개인 Study.연산자
// Study.비트연산자 : 비트 단위의 연산을 수행
...
public class OperatorMain {
    public static void main(String[] args) {
        ...
        System.out.println((double) x / y);  // 나눗셉을 위해 명시적인 형변환
        System.out.println(x % y); // 나머지 Study.연산자, 알고리즘에서는 산술연산자 중에서 나머지 연산자가 많이 사용됨
        ...
        // 논리연산자
        int num5 = 10, num6 = 20;
        System.out.println(num5 > 0 && num5 > num6);  // 산술연산자가 논리연산자 보다 우선 순위가 높음, false
        System.out.println(num5 > 0 || num5 > num6);  // true
        System.out.println(!(num5 > 0 || num5 > num6)); // false

        // 3항연산자 : 참과 거짓만 있는 Study.조건문 대체
