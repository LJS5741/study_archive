...
// continue : Study.반복문 내에서 사용, 반복문의 나머지 부분은 건너뛰고 조건식으로 이동 함
...
//        }
        ...
        // continue를 이용해 입력 받은 수의 범위 이내의 5의 배수를 1줄에 10개씩 출력 하기
        int cnt = 0;
        for (int i = 1; i <= num; i++) {
            if (i % 5 != 0) continue; // 5의 배수가 아니면 반복문의 나머지 부분은 거너뜀
