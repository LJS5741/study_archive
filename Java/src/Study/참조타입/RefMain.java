package Study.참조타입;
// 기본 타입 : 할당 받은 메모리 공간에 값이 대입되는 방식 (boolean, int, char, long....)
// 참조 타입 : 할당 받은 메모리 공간에 객체의 주소다 대입되는 방식 (배열, 열거 타입, 클래스, Study.인터페이스)
...
public class RefMain {
    public static void main(String[] args) {
        ...
        // 주소를 비교
        if (name1 == name3) {  // 주소를 비교 하게 됨, 즉 참조하는 문자열의 주소가 같은 지 확인
